...
function TicketApp() {
  return (
    <div class="pb-[3rem]">
      <h4 class="font-bold text-[18px] text-[#000000] text-center">
        Do more with the Teeket App
      </h4>
      <h6 class="font-normal text-[14px] text-[#000000] text-center mt-[1rem]">
      ...
      <img src={app} class="mx-auto mt-[1.5rem]" alt="phone_image" />
      <h4 class="text-center font-bold text-[16px] text-[#2068F7]">
        That’s not all!
      </h4>
      <h6 class="font-normal text=[14px] text-center text-[#000000] mt-[0.5rem]">
